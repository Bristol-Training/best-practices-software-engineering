...
The other thing that is part of the interface of a function is any exceptions that are *raised* by it. If you need a refresher on exceptions and error handling in Python, take a look at [the chapter on it in the Intro to Python 2 course](https://bristol-training.github.io/intro-python-2/pages/040-errors-exceptions.html).
